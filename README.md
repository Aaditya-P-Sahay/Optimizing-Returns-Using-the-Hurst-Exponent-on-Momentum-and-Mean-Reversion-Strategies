...
**⚠️ IMPORTANT: Run cells in order (1 → 8) and wait for each to complete**
...
### 🏗️ **Cell 2: Stock Selection & Data Setup**
...
### ⚖️ **Cell 6: Balanced Hurst Strategy**
...
### 🎛️ **Cell 8: Interactive Risk-Return Optimization**
